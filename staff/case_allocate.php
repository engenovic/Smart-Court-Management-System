...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="panel-body">
      					<form action="acase.php" method="post" role="form" class="form-horizontal">
      						<div class="form-group">
      							...
      							<div class="col-md-8">
      								<div class="input-group">
      									...
      									<input type="date" name="date" class="form-control1" >
      								</div>
      							</div>
      						</div>
                  <div class="form-group">
                        ...
                        <select name="case" class="form-control mt-3">
                                                <option>
                                               Select Case
                                                </option>
                                                <?php
                                                  foreach($cases as $case) {
                                                    echo "<option value=\"{$case['caseID']}\" >{$case['title']} {$case['description']}</option>";
                                                  }
                                                  ?>
                  ...
                  <div class="form-group">
      							<label class="col-md-2 control-label">Magistrate</label>
      							<div class="col-md-8">
      								<div class="input-group input-icon right">
      									<span class="input-group-addon">
      										<i class="fa fa-user"></i>
      									</span>
                        <select name="magis" class="form-control mt-3">
                                                <option>
                                               Select Magistrate
                                                </option>
                                                <?php
                                                  foreach($magis as $mg) {
                                                    echo "<option value=\"{$mg['idno']}\" >{$mg['fname']} {$mg['lname']}</option>";
                                                  }
                                                  ?>
                  ...
                  <div class="form-group">
      							<label class="col-md-2 control-label">Court Room</label>
      							<div class="col-md-8">
      								<div class="input-group input-icon right">
      									<span class="input-group-addon">
                        ...
                        <select name="room" class="form-control mt-3">
                                               ...
                                               Select Room
                                                ...
                                                <?php
                                                  foreach($rooms as $rm) {
                                                    echo "<option value=\"{$rm['rid']}\" >{$rm['name']} {$rm['description']}</option>";
                                                  }
                                                  ?>
