...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="panel-body">
      					<form method="post" action="csign.php" role="form" class="form-horizontal">
      						...
      						<div class="form-group">
      							...
      							<div class="col-md-8">
      								<div class="input-group input-icon right">
      									...
      									<input id="email" name="phone" class="form-control1" type="text" placeholder="Enter Phone Number">
      								</div>
      							</div>
      						</div>
      						<div class="form-group">
      							...
      							<div class="col-md-8">
      								<div class="input-group input-icon right">
      									...
      									<input type="text" name="location" class="form-control1" placeholder="Enter Location">
      								</div>
      							</div>
      						</div>
                  <div class="form-group">
                        ...
                        <select name="client" class="form-control mt-3">
                                                <option>
                                               Select Client
                                                </option>
